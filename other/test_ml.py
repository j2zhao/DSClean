"""
An example pipeline: Imported from MLInspext
"""
import os
import warnings
...
from test_ml_utils import MyW2VTransformer, create_model
...
patients = pd.read_csv("healthcare_patients.csv", na_values='?')
histories = pd.read_csv("healthcare_histories.csv", na_values='?')
